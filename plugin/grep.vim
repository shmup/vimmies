...
command! -nargs=+ -complete=file_in_path -bar Grep cgetexpr system(&grepprg . ' <q-args>')
command! -nargs=+ -complete=file_in_path -bar LGrep lgetexpr system(&grepprg . ' <q-args>')
